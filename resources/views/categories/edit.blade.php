...
<div class="container mt-5">
    <h1 class="mb-4 text-success"><i class="bi bi-pencil-square"></i> Edit Category</h1>
            ...
            <form action="{{ route('categories.update', $category->id) }}" method="POST">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" name="description" id="description" class="form-control form-control-lg @error('description') is-invalid @enderror" 
                           value="{{ old('description') ?? $category->description }}" placeholder="Enter category description" required>
                    @error('description')
                        <div class="invalid-feedback">
                            {{ $message }}
                        </div>
